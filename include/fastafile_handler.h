...
long buildUndamagedGenomeTemplate_MM(char*, std::size_t, int, int, const std::string*, std::vector<double>&);
void getReverseComplementarySeq(const std::string&, std::string&);
