...
public:
    ...
    */
    ...
    static void generate_paired_reads_with_indel(ART&, ART&, int, std::vector<double>&, int);           // Function to generate two paired-reads from the opposite ends of the same DNA fragment
